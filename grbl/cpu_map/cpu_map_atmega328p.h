...
#define STEPPERS_DISABLE_PORT   vPORTD
...
#define RESET_BIT         4  // Uno Analog Pin 0
#define FEED_HOLD_BIT     5  // Uno Analog Pin 1
#define CYCLE_START_BIT   7  // Uno Analog Pin 2
#define SAFETY_DOOR_BIT   4  // Uno Analog Pin 1 NOTE: Safety door is shared with feed hold. Enabled by config define.
